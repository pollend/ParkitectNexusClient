...
{
    public class AssetSidebarModContainer : AssetSidebarContainer
    {
        private readonly IQueueableTaskManager _queueableTaskManager;
        private readonly MainView _mainview;
        public AssetSidebarModContainer(IAsset asset,ILogger logger,MainView mainView,IQueueableTaskManager queueableTaskManager,IWebsite website,IParkitect parkitect,SidebarContainer sidebarContainer) : base(asset,logger,parkitect,sidebarContainer,website)
        {
            _mainview = mainView;
